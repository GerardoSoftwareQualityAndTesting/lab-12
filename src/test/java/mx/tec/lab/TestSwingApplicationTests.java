...
class TestSwingApplicationTests {
	...
	@Test
	void givenTwoChars_WhenSum_ThenClearFields() {
		// Given a and b
		...
		String fieldOne = application.numberOneTextField.getText();
		String fieldTwo = application.numberTwoTextField.getText();
		assertEquals(expectedResult, fieldOne, fieldTwo);
	}
